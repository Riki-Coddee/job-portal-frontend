              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {jobTypes.map((type) => (
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      setFormData((prev) => ({ ...prev, job_type: type.id }))
                    }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Leave empty if you want to display "Competitive Salary"
              </p>
            </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  The job will be published as soon as you submit
                </p>
              </div>
              <input
                type="radio"
            ...
            <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Choose when to publish this job listing
                </p>
              </div>
              <input
                type="radio"
